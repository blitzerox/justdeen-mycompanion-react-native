 ...
 * Reflect Screen
 *
 * Week 17: Main screen with Duas, Hadith, Names
 */
...
export const ReflectHomeScreen: React.FC<ReflectStackScreenProps<"ReflectHome">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.reflect }]}>Reflect</Text>
