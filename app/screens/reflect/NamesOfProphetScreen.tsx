/**
 * Names of Prophet Screen
 *
 * Week 17: Names of Prophet Muhammad
 */
...
export const NamesOfProphetScreen: React.FC<ReflectStackScreenProps<"NamesOfProphet">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.reflect }]}>Names of Prophet</Text>
