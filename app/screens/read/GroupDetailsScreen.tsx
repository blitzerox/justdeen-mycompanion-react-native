 ...
 *
 * Week 18-19: Group info and members
 */
...
export const GroupDetailsScreen: React.FC<ReadStackScreenProps<"GroupDetails">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.read }]}>Group Details</Text>
