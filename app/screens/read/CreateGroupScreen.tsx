 ...
 * Create Group Screen
 *
 * Week 18-19: Create new reading group
 */
...
export const CreateGroupScreen: React.FC<ReadStackScreenProps<"CreateGroup">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.read }]}>Create Group</Text>
