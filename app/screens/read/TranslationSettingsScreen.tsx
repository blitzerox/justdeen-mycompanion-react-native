 ...
 *
 * Week 12-15: Manage translations
 */
...
export const TranslationSettingsScreen: React.FC<ReadStackScreenProps<"TranslationSettings">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.read }]}>Translation Settings</Text>
