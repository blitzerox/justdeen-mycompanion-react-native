/**
 * Reading Groups Screen
 *
 * Week 18-19: Community reading groups
 */
...
export const ReadingGroupsScreen: React.FC<ReadStackScreenProps<"ReadingGroups">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.read }]}>Reading Groups</Text>
