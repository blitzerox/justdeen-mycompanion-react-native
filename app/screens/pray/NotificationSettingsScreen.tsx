 ...
 *
 * Week 8-10: Adhan and notification preferences
 */
...
export const NotificationSettingsScreen: React.FC<PrayStackScreenProps<"NotificationSettings">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.pray }]}>Notification Settings</Text>
