 ...
 *
 * Week 8-10: Hijri calendar with Islamic events
 */
...
export const IslamicCalendarScreen: React.FC<PrayStackScreenProps<"IslamicCalendar">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.pray }]}>Islamic Calendar</Text>
