 ...
 *
 * Week 6-7: User profile and account
 */
...
export const ProfileSettingsScreen: React.FC<SettingsStackScreenProps<"ProfileSettings">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.settings }]}>Profile Settings</Text>
