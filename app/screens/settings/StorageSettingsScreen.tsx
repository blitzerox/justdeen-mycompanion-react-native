 ...
 *
 * Week 12-15: Offline data, cache management
 */
...
export const StorageSettingsScreen: React.FC<SettingsStackScreenProps<"StorageSettings">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.settings }]}>Storage Settings</Text>
