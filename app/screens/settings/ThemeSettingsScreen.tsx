...
export const ThemeSettingsScreen: React.FC<SettingsStackScreenProps<"ThemeSettings">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.settings }]}>Theme Settings</Text>
