 ...
 *
 * Week 6-7: Data privacy, analytics opt-out
 */
...
export const PrivacySettingsScreen: React.FC<SettingsStackScreenProps<"PrivacySettings">> = () => {
  const {
    theme: { colors },
  } = useAppTheme()
  ...
  return (
    <Screen preset="scroll" contentContainerStyle={styles.container}>
      <View style={[styles.content, { backgroundColor: colors.background }]}>
        <Text style={[styles.title, { color: colors.settings }]}>Privacy Settings</Text>
